...
int main()
{
    ...
    *************************************************************************/
    ...
    cv::Mat intrinsic_matrix = cv::Mat::zeros(3,3,CV_64FC1);    /*****    摄像机内参数矩阵    ****/
    cv::Mat distortion_coeffs = cv::Mat::zeros(4,1,CV_64FC1);     /* 摄像机的4个畸变系数：k1,k2,k3,k4*/
    ...
    *************************************************************************/
    ...
    fout<<"Image_size:" <<image_size <<endl;
    fout<<"相机内参数矩阵："<<endl;
    ...
    /************************************************************************
           显示定标结果
    *************************************************************************/
    cv::Size size = cv::Size(image_size.width,image_size.height);
    Mat mapx = Mat(size,CV_32FC1);
    Mat mapy = Mat(size,CV_32FC1);
    Mat R = Mat::eye(3,3,CV_32F);
    cout<<"保存矫正图像"<<endl;

     fisheye::initUndistortRectifyMap(intrinsic_matrix,distortion_coeffs,R,intrinsic_matrix,size,CV_32FC1,mapx,mapy);
